...
file_obj = open('./weights_biases/weight_layer1.txt', 'w')
np.save(file_obj, W)
file_obj.close()

file_obj1 = open('./weights_biases/weight_layer2.txt', 'w')
np.save(file_obj1, W1)
file_obj1.close()

file_obj = open('./weights_biases/weight_layer3.txt', 'w')
np.save(file_obj, W2)
file_obj.close()

file_obj = open('./weights_biases/bias_layer1.txt', 'w')
np.save(file_obj, b)
file_obj.close()

file_obj1 = open('./weights_biases/bias_layer2.txt', 'w')
np.save(file_obj1, b1)
file_obj1.close()

file_obj = open('./weights_biases/bias_layer3.txt', 'w')
np.save(file_obj, b2)
file_obj.close()
